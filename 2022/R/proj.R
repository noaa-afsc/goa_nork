...
model_name = "nr"
fishery = "fsh"
TAC = c(4529, 4312, 5358)

# move proj file to new folder
file.copy(here::here(year, model, "proj.dat"),
          here::here(year, model, "proj", "data", "goa_northern.dat"))
...
setup<-readLines(here::here(year, model, "proj","setup.dat"),warn=FALSE)
...
write.table(setup,file=here::here(year, model, "proj","setup.dat"),quote=F,row.names=F,col.names=F)
...
write.table(spp_catch,file=here::here(year, model, "proj", "spp_catch.dat"),quote=F,row.names=F,col.names=F)
write.table(spp_catch,file=here::here(year, model, "proj", "data","goa_northern_max_spcat.dat"),quote=F,row.names=F,col.names=F)
...
setwd(here::here(year, model, "proj"))
shell("main.exe")

# Read results from Max scenario
bigfile_write<-readLines(here::here(year, model, "proj", "bigfile.out"),warn=FALSE)
bigfile<-read.delim(here::here(year, model, "proj", "bigfile.out"),sep="", header=T)
F_profile<-readLines(here::here(year, model, "proj", "F_profile.out"),warn=FALSE)
means<-readLines(here::here(year, model, "proj", "means.out"),warn=FALSE)
percentdb<-readLines(here::here(year, model, "proj", "percentdb.out"),warn=FALSE)
percentiles<-readLines(here::here(year, model, "proj", "percentiles.out"),warn=FALSE)
...
write.table(bigfile_write,file= here::here(year, model, "proj", "maxout", "bigfile.out"),quote=F,row.names=F,col.names=F)
write.table(F_profile,file= here::here(year, model, "proj", "maxout"," F_profile.out"),quote=F,row.names=F,col.names=F)
write.table(means,file= here::here(year, model, "proj", "maxout", "means.out"),quote=F,row.names=F,col.names=F)
write.table(percentdb,file= here::here(year, model, "proj", "maxout", "percentdb.out"),quote=F,row.names=F,col.names=F)
write.table(percentiles,file= here::here(year, model, "proj", "maxout", "percentiles.out"),quote=F,row.names=F,col.names=F)
write.table(bigsum,file= here::here(year, model, "proj", "maxout", "bigsum.dat"),quote=F,row.names=F,col.names=c("Alt","Stock","Year","ABC","OFL","Catch","SSB","F","Total_Biom"))
...
write.table(spp_catch,file=here::here(year, model, "proj", "spp_catch.dat"),quote=F,row.names=F,col.names=F)
write.table(spp_catch,file=here::here(year, model, "proj", "data", "goa_northern_spcat.dat"),quote=F,row.names=F,col.names=F)
...
# Write results from max scenario
write.table(bigfile_write,file=here::here(year,model,  "proj", "author_f", "bigfile.out"),quote=F,row.names=F,col.names=F)
write.table(F_profile,file=here::here(year, model, "proj", "author_f", "F_profile.out"),quote=F,row.names=F,col.names=F)
write.table(means,file=here::here(year, model, "proj", "author_f", "means.out"),quote=F,row.names=F,col.names=F)
write.table(percentdb,file=here::here(year, model, "proj", "author_f", "percentdb.out"),quote=F,row.names=F,col.names=F)
write.table(percentiles,file=here::here(year, model, "proj", "author_f", "percentiles.out"),quote=F,row.names=F,col.names=F)
write.table(bigsum,file=here::here(year, model, "proj", "author_f", "bigsum.dat"),quote=F,row.names=F,col.names=c("Alt","Stock","Year","ABC","OFL","Catch","SSB","F","Total_Biom"))
...
plot_compare_survey(year, models = c('2022, base', '2022, m18.2b', '2022, m22', '2022, m22.1'))
plot_compare_biomass(year, models = c('2022, base', '2022, m18.2b', '2022, m22', '2022, m22.1', '2022, m22.1a', '2022, m22.1b'))