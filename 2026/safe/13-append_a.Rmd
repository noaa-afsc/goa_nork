...
data.frame(Year = as.character(2010:2023),
           Other = c(rep("<1", 8), NA, "<1", "<1", NA, NA, NA),
           Trawl = c("<1", 11, "<1", 19, "<1", 8, NA, 7, "<1", 5, "<1", 6, "<1", 2),
           Recreational = c(rep(NA, 3), "<1", rep(NA, 10)),
           Total = c("<1", 11, "<1", 18, "<1", 8, "<1", 7, "<1", 5, "<1", 6, "<1", 2)) %>% 
  flextable::flextable() %>% 
